...
export const AiMessagingSettings: GlobalConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        {
          name: 'outOfStockRecoveryEnabled',
          type: 'checkbox',
          defaultValue: true,
          label: 'Suggest verified alternatives when an option is out of stock',
        },
        {
          name: 'outOfStockAllowOtherColours',
          type: 'checkbox',
          defaultValue: true,
          label: 'Suggest other colours of the same product',
        },
        {
          name: 'outOfStockAllowOtherSizes',
          type: 'checkbox',
          defaultValue: true,
          label: 'Show other available sizes without presenting them as equivalent',
        },
        {
          name: 'outOfStockMaxAlternatives',
          type: 'number',
          required: true,
          min: 1,
          max: 5,
          defaultValue: 3,
          label: 'Maximum alternative products',
        },
        {
          name: 'outOfStockPriceTolerancePercent',
          type: 'number',
          required: true,
          min: 0,
          max: 100,
          ...
          admin: { description: 'Related products outside this difference from the requested product are excluded.' },
        },
        {
          name: 'outOfStockCategoryWeight',
          type: 'number',
          required: true,
          min: 0,
          max: 100,
          defaultValue: 60,
          label: 'Same-category ranking weight',
        },
        {
          name: 'outOfStockTagWeight',
          type: 'number',
          required: true,
          min: 0,
          max: 100,
          defaultValue: 40,
          label: 'Shared merchandising-tag ranking weight',
        },
      ],
    },
  ],
