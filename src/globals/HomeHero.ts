...
export const HomeHero: GlobalConfig = {
  ...
  fields: [
    ...
    {
      name: 'heroDesktopPositionX',
      type: 'number',
      label: 'Desktop image — horizontal position (%)',
      min: 0,
      max: 100,
      defaultValue: 65,
      admin: { description: '0 = left, 100 = right. Applied where the image is cropped to fit the screen.' },
    },
    {
      name: 'heroDesktopPositionY',
      type: 'number',
      label: 'Desktop image — vertical position (%)',
      min: 0,
      max: 100,
      defaultValue: 20,
      admin: { description: '0 = top, 100 = bottom. Applied where the image is cropped to fit the screen.' },
    },
    {
      name: 'heroMobilePositionX',
      type: 'number',
      label: 'Mobile image — horizontal position (%)',
      min: 0,
      max: 100,
      defaultValue: 50,
      admin: { description: '0 = left, 100 = right. Applied where the image is cropped to fit the screen.' },
